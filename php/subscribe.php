...
$apiKey       = 'ed50ac70d1669fb80f345411b6ce443e-us14'; /*Your Mailchiimp API Key*/
$listId       = '040a82c529'; /*Mailchimp List ID*/
$double_optin = true; /*Set False if you don't need to verify user email */
